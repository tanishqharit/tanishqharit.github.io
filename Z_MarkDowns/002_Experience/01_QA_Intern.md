...
`Bugzilla` &nbsp;·&nbsp; `Manual Testing` &nbsp;·&nbsp; `Software Development Life Cycle` &nbsp;·&nbsp; `Defect Lifecycle Management` &nbsp;·&nbsp; `Business Requirements Validation` &nbsp;·&nbsp; `Teamwork`
...
Very different from any project I had worked on so far.
...
|---|---|
| **Day One** | My HR point of contact introduced me to my manager, QA team, and developers. Having my own credentials, desk, and desktop made me feel that I had entered the real world. The day was casual with office tours, visiting different divisions, and going to a nearby mall with my team. |
| **Week 1 (Learning to See)** | I haven't tested anything yet; my first task was to learn about the **Software Development Life Cycle (SDLC)**. Learning came from observing it happening in real-time: programmers pushing code, testers reporting bugs, teams adapting to new timelines when deadlines were missed. I learned more about software development in a week than I did in two years of college. |
...
This internship taught me things no classroom could. I learned what it actually means to work in a structured corporate environment — reporting chains, 
documentation standards, and the very real weight of working on something people actually depend on.

On the technical side, I got my first real look at how large-scale data platforms are tested — not just *"does it work"* but *"does it work correctly, for every edge case, at scale, under real data."* That mindset stuck with me and shaped how I think about data quality even now.

I also learned that QA is a lot more than finding bugs. It's about understanding a system well enough to know *where to look* — and having the patience to look carefully.

And somewhere in those three months, watching financial data at a national scale, I realized I wanted to work closer to the data side of things. That curiosity is what eventually led me to where I am today.
